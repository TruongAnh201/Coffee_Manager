...
namespace QuanLyCafe
{
    public partial class fr_CTHDB : Form
    {
        ...
        public void hienthi()
        {
            string sql = @"SELECT mahdb, tensp, tb_CTHDB.soluong, khuyenmai, thanhtien
                        FROM tb_CTHDB
        ...
        private void btluu_Click(object sender, EventArgs e)
        {
            if (cbhang.SelectedValue.ToString() != "")
            {
                if (themmoi == true)
                {
                    try
                    {
                        ...
                        if(int.Parse(txtsl.Text) <= int.Parse(lbsolg.Text))
                        {
                        ...
                        {
                            MessageBox.Show("Hàng trong kho còn không đủ", "Chú Ý", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            thucthi.loadsoluong(lbsolg.Text, cbhang.Text);
        }
        ...
        {
            lbsolg.Text = thucthi.loadsoluong(lbsolg.Text, cbhang.SelectedValue.ToString());
            txtdg.Text = thucthi.loaddg(txttt.Text, cbhang.SelectedValue.ToString());
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {            
                ...
                sql = @"SELECT tb_HDB.mahdb, tb_Khachhang.tenkh, tb_HDB.ngayban, tb_Nhanvien.tennv
                      FROM  tb_CTHDB
                ...
                exBook.SaveAs(Application.StartupPath + "/Hóa Đơn Bán.xlsx");
                exApp.Visible = true;
            }
            catch (Exception ex)
            {
