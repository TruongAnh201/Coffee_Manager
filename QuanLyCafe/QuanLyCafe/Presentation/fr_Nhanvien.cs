...
namespace QuanLyCafe.Presentation
{
    public partial class fr_Nhanvien : Form
    {
        ...
        public void hienthi()
        {
            string sql = @"SELECT manv, tennv, diachi, gioitinh, ngaysinh, tenque, sdt 
                        FROM tb_Nhanvien
                        INNER JOIN tb_Que on tb_que.maque = tb_Nhanvien.maque";
        ...
        private void btluu_Click(object sender, EventArgs e)
        {
            if (txtma.Text != "")
            {
                if (cbmaque.SelectedValue.ToString() != "")
                {
                    if (themmoi == true)
                    {
                        try
                        {
                            ...
                            ck.MAQUE = cbmaque.SelectedValue.ToString();
