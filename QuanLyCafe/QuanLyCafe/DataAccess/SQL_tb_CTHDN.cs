...
namespace QuanLyCafe.DataAccess
{
    class SQL_tb_CTHDN
    {
        ...
        public void suacthdb(EC_tb_CTHDN cthdb)
        {
            ...
            SET soluong =N'" + cthdb.SOLUONG + "', khuyenmai = N'" + cthdb.KHUYENMAI + "', thanhtien = N'" + cthdb.THANHTIEN + "' where mahdn=N'" + cthdb.MAHDN + "' and masp=N'" + cthdb.MASP + "'");
        ...
        {
            cn.LoadLenCombobox(mahdn, "SELECT     mahdn FROM tb_HDN");
        }
        //load đơn giá bán
